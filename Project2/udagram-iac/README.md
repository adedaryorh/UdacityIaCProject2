...
<h3 align="center">Deploy Infrastructure as Code (IAC)<br>Deploy a high-availability web app using CloudFormation<br>Udagram <i>(a ahigh-availability web app using CloudFormation)</i></h3>  
